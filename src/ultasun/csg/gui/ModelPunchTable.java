 ...
 * @author ultasun
 */
public class ModelPunchTable implements TableModel {
    ...
    public ModelPunchTable(List<PunchTableRow> values) {
        this(values, values.get(0).getKeys(), false);
    }
    
    public ModelPunchTable(List<PunchTableRow> values, List<String> printKeys, boolean insertColumnHeaders) {
